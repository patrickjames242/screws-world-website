...
export default function AboutUs() {
  ...
  const pageHeaderProps: PageHeaderProps = {
    title: "About Us",
    subtitle:
      "Learn why Screws and Fasteners World is the number one fasteners retailer in The Bahamas.",
  };

  const youtubeVideoEmbed = (
    <iframe
      title="Screws & Fasteners World Commercial"
      width={560}
      height={315}
      style={{ height: "100%", width: "100%" }}
      src="https://www.youtube.com/embed/K_msVolL0Jk"
      frameBorder={0}
...
function IntroBox() {
  ...
  useClassNameWhenElementWidthEqualsWindowWidth(
    "stick-to-sides",
    contentHolderRef
  );

  return (
    <ScreenWidthStretchingBox className="IntroBox">
  ...
  const items: IntroBoxRightListItemProps[] = [
    {
      ...
      description:
        "Screws World is owned an operated by Bahamians in Nassau, Bahamas.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Screws World is the self-proclaimed number one screws and fasteners store in The Bahamas.",
    },
  ];
  return items;
})();
...
function IntroBoxRightListItem(props: { title: string; description: string }) {
  return (
    <div className="IntroBoxRightListItem">
...
function CenteredTitleAndDescription(props: {
  className?: string;
  title: string;
  description: string;
}) {
...
function CenteredTitleAndDescriptionWithBottomBox(props: {
  className?: string;
  title: string;
  description: string;
  bottomBoxChildren?: React.ReactNode;
}) {
  ...
  return (
    <ScreenWidthStretchingBox className={className}>
...
function ScreenWidthStretchingBox(props: {
  className?: string;
...
function useClassNameWhenElementWidthEqualsWindowWidth(
  className: string,
