...
console.warn("most sundays open, sometimes open on holidays. Edit all places that say this.");
console.warn("compress images before they are uploaded to the server");